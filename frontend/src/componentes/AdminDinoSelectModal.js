...
const herbivoreOptions = [
    {
        value: 'triceratops',
        label: 'Triceratops',
        path: '/triceraptors/triceraptors',
        frameCount: 4,
        fps: 4,
        previewPath: '/triceraptors/triceraptors1.png',
        info: 'El clásico herbívoro de tres cuernos. Robusto y fiable.'
    },
    {
        ...
        info: 'Un gentil gigante para añadir variedad al recinto.'
    }
];

const jeepOptions = [
    { value: 'Green', label: 'Jeep Verde', previewPath: '/Jeep/Jeep_Green/MOVE/SOUTH/SEPARATED/Green_JEEP_CLEAN_SOUTH_000.png' },
    { value: 'Brown', label: 'Jeep Marrón', previewPath: '/Jeep/Jeep_Brown/MOVE/SOUTH/SEPARATED/Brown_JEEP_CLEAN_SOUTH_000.png' },
    { value: 'Black', label: 'Jeep Negro', previewPath: '/Jeep/Jeep_Black/MOVE/SOUTH/SEPARATED/Black_JEEP_CLEAN_SOUTH_000.png' },
];

const aviaryPreview = { value: 'volador', previewPath: '/volador/volador1.png', frameCount: 12, fps: 10 };
const aquaPreview = { value: 'marino', previewPath: '/marino/marino1.png', frameCount: 2, fps: 2 };
...
const AdminDashboard = ({ onSalirClick }) => {
    ...
    // --- ESTADO DE ASSETS ACTUALIZADO ---
    const [jeepColor, setJeepColor] = useState('Green');
    const [carnivoreDino, setCarnivoreDino] = useState('RedDino');
    const [herbivoreDino, setHerbivoreDino] = useState('triceratops'); // Ahora es seleccionable
    // --- 'herbivoreDinoSecundario' ELIMINADO ---
    ...
    useEffect(() => {
        const fetchAdminData = async () => {
            ...
            try {
                ...
                setHerbivoreDino(config.herbivoreDino || 'triceratops');
    ...
    return (
        <div className="admin-dashboard">
                    ...
                    <div className="dashboard-section asset-config-section">
                        ...
                        <div className="asset-config-grid">
                            ...
                            <div className="asset-selector">
                                ...
                                <img src={getPreviewPath(herbivoreDino)} alt="Dino Herbívoro" className="asset-preview" title={herbivoreDino} />
                                <button
                                    className="change-asset-btn"
            ...
            <AdminDinoSelectModal
              ...
              description="Elige la especie que se mostrará en el recinto de herbívoros."
            />
        </div>
    );
};
